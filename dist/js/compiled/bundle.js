...
var MainModule = function () {
    ...
    var sortData = function sortData() {
        ...
        _pagination2.default.updatePage({ totalPages: Data.dataPages.length - 1 });
    };
    ...
    var events = function events() {
        _pagination2.default.elements.container.addEventListener("click", function (e) {
            if (!e.target.dataset.page) return;
            var pageNumber = e.target.dataset.page;
            pageNumber = parseInt(pageNumber) - 1;
            _pagination2.default.updatePage({ actualPage: pageNumber });
            _table2.default.addDataToTable(Data.dataPages[pageNumber]);
        });

        _pagination2.default.elements.backButton.addEventListener("click", function (e) {
            if (this.dataset.enabled === "false") return;
            var previousPage = _pagination2.default.checkActualPage() - 1;
            _table2.default.addDataToTable(Data.dataPages[previousPage]);
            _pagination2.default.updatePage({ actualPage: previousPage });
        });

        _pagination2.default.elements.nextButton.addEventListener("click", function (e) {
            if (this.dataset.enabled === "false") return;
            var nextPage = _pagination2.default.checkActualPage() + 1;
            _table2.default.addDataToTable(Data.dataPages[nextPage]);
            _pagination2.default.updatePage({ actualPage: nextPage });
        });
        ...
        _table2.default.header.addEventListener("click", function (e) {
            ...
            _table2.default.addDataToTable(Data.dataPages[0]);
            _pagination2.default.updatePage({ actualPage: 0 });
...
var PaginationModule = function () {
    ...
    var updatePage = function updatePage(newProperties) {
        properties = _extends({}, properties, newProperties);

        styleActualPage();
    };

    var checkActualPage = function checkActualPage() {
    ...
    var styleActualPage = function styleActualPage() {
        // set style to actualy used page number
        if (elements.container.querySelector("[data-actual='true']")) resetStyleOfPrevious();

        var actualPageButton = elements.container.querySelector("[data-page='" + (properties.actualPage + 1) + "']");
        actualPageButton.classList.add("selected");
        actualPageButton.dataset.actual = "true";
        styleBackNextButtons();
    };

    var resetStyleOfPrevious = function resetStyleOfPrevious() {
        // reset style previous selected site number after select another
        var previousUsedPage = elements.container.querySelector("[data-actual='true']");
        previousUsedPage.classList.remove("selected");
        previousUsedPage.dataset.actual = "false";
    };

    var styleBackNextButtons = function styleBackNextButtons() {
        //Enable buutons back and next
    ...
    return {
        elements: elements,
        checkActualPage: checkActualPage,
        updatePage: updatePage,
        clearPagination: clearPagination,
        createPagination: createPagination,
        styleActualPage: styleActualPage
    };
}();
